...
110 FORMAT( '%%% TOTAL # OF FIELDS TO BE REGRIDDED : ', i5 )
    ...
    IF ( doNestAf ) THEN
       ...
       CALL NcOutFileDef( I_NestAf,  J_NestAf,     L025x03125+1, TIMES_A3, &
    ...
    IF ( doNestMe ) THEN
       ...
       CALL ExpandDate  ( fName,     yyyymmdd,  000000                     )
       CALL StrRepl     ( fName,     '%%%%%%',  'A3mstE'                   )
       CALL NcOutFileDef( I_NestMe,  J_NestMe,  L025x03125+1,    TIMES_A3,  &
    ...
    IF ( doNestOc ) THEN
       ...
       CALL ExpandDate  ( fName,     yyyymmdd,  000000                     )
       CALL StrRepl     ( fName,     '%%%%%%',  'A3mstE'                   )
       CALL NcOutFileDef( I_NestOc,  J_NestOc,  L025x03125+1,    TIMES_A3,  &
    ...
    IF ( doNestRu ) THEN
       ...
       CALL ExpandDate  ( fName,     yyyymmdd,  000000                     )
       CALL StrRepl     ( fName,     '%%%%%%',  'A3mstE'                   )
       CALL NcOutFileDef( I_NestRu,  J_NestRu,  L025x03125+1,    TIMES_A3,  &
    ...
    IF ( doNestSa ) THEN
       ...
       CALL ExpandDate  ( fName,     yyyymmdd,  000000                     )
       CALL StrRepl     ( fName,     '%%%%%%',  'A3mstE'                   )
       CALL NcOutFileDef( I_NestSa,  J_NestSa,  L025x03125+1,    TIMES_A3,  &
