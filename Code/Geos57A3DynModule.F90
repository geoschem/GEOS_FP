...
100 FORMAT ( '%%% Defining netCDF file vars & attrs for ', a' grid' )
    ...
    ! CMFMC
    IF ( StrPos( 'CMFMC', tavg3_3d_mst_Ne_data_d ) >= 0 ) THEN
...
!
    ...
    CALL GetNFields( tavg3_3d_mst_Ne_data_d, nFields_3dMstNe, fields_3dMstNe )
...
110 FORMAT( '%%% TOTAL # OF FIELDS TO BE REGRIDDED : ', i5 )
    ...
    ! Echo info
    msg = '%%%%%%%%%% LEAVING ROUTINE Geos57MakeA3Dyn %%%%%%%%%%'
    WRITE( IU_LOG, '(a)' ) '%%%'   
    WRITE( IU_LOG, '(a)' ) TRIM( msg )

  END SUBROUTINE Geos57MakeA3Dyn
!EOC
!------------------------------------------------------------------------------
!          Harvard University Atmospheric Chemistry Modeling Group            !
!------------------------------------------------------------------------------
