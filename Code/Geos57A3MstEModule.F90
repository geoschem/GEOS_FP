...
!BOP
!
! !MODULE: Geos57A3MstEModule
!
! !DESCRIPTION: Module Geos57A3MstEModule contains routines to create the 
!  GEOS-Chem average 3-hr data files from the GEOS-5.7.x raw data.
!\\
!\\
! !INTERFACE: 
...
100 FORMAT ( '%%% Defining netCDF file vars & attrs for ', a' grid' )
    ...
    CALL NcWr( Ap,    fOut, 'ap',   (/ 1 /), (/ Z /) )
    CALL NcWr( Bp,    fOut, 'bp',   (/ 1 /), (/ Z /) )
...
!BOP
!
! !IROUTINE: Geos57MakeA3MstE
!
! !DESCRIPTION: Routine Geos57MakeA3MstE is the the driver routine for 
! \begin{enumerate}
...
!
    ...
    ! Echo info    
    msg = '%%%%%%%%%% ENTERING ROUTINE Geos57MakeA3MstE %%%%%%%%%%'
    WRITE( IU_LOG, '(a)' )
    WRITE( IU_LOG, '(a)' ) TRIM( msg )
...
110 FORMAT( '%%% TOTAL # OF FIELDS TO BE REGRIDDED : ', i5 )
    ...
    ! Echo info
    msg = '%%%%%%%%%% LEAVING ROUTINE Geos57MakeA3mstE %%%%%%%%%%'
    WRITE( IU_LOG, '(a)' ) '%%%'   
    WRITE( IU_LOG, '(a)' ) TRIM( msg )

  END SUBROUTINE Geos57MakeA3MstE
!EOC
!------------------------------------------------------------------------------
!          Harvard University Atmospheric Chemistry Modeling Group            !
!------------------------------------------------------------------------------
