...
!BOP
!
! !MODULE: Geos57UtilityModule
!
! !DESCRIPTION: Module Geos57UtilModule contains several utility routines
!  for the GEOS-5.7.x regridding package.
!\\
!\\
! !INTERFACE: 
!
...
!EOC
END MODULE Geos57UtilityModule
